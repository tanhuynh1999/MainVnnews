...
namespace VnnewsNews.Areas.Admin.Controllers
{
    public class CategoriesAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "category_id,category_name,category_view,category_active,category_datecreate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "category_id,category_name,category_view,category_active,category_datecreate")] Category category)
        {
            if (ModelState.IsValid)
            {
                category.category_datecreate = DateTime.Now;
